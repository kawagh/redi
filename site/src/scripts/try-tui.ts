...
const L = {
  en: {
    ...
    statusIssues: "jk:move /:search f:filter ?:help q:quit",
    statusWiki: "jk:move /:search ?:help q:quit",
  ...
  ja: {
    ...
    statusIssues: "jk:移動 /:検索 f:フィルタ ?:ヘルプ q:終了",
    statusWiki: "jk:移動 /:検索 ?:ヘルプ q:終了",
    page: (a: number, b: number, n: number) => `Page 1/1 (${a}-${b} / ${n})`,
